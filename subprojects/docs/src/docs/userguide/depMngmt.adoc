...
Another aspect of metadata that can be understood and adjusted are the dependencies declared in the metadata. If these are flawed or too strict, a rule can be used to adjust them. For example:
++++
<sample id="adjustPublishedDependencies" dir="componentMetadataRules" title="Adjust published dependencies">
                <sourcefile file="build.gradle" snippet="adjust-published-dependencies"/>
            </sample>
++++
