...
class VisualCppPlatformToolProvider extends AbstractPlatformToolProvider {
    ...
    protected Compiler<CppCompileSpec> createCppCompiler() {
        ...
        return versionedNativeCompiler(outputCleaningCompiler);
    }
    ...
    private <T extends NativeCompileSpec> VersionedNativeCompiler<T> versionedNativeCompiler(Compiler<T> compiler) {
        return new VersionedNativeCompiler<T>(compiler, VisualCppToolChain.DEFAULT_NAME, visualCpp.getVersion(), getSystemIncludes());
    }
