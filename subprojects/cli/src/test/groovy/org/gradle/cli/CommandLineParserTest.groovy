...
class CommandLineParserTest extends Specification {
    ...
    def formatsUsageMessageForDeprecatedAndIncubatingOptions() {
        ...
        parser.printUsage(outstr)
        outstr.toString().readLines() == [
            '-a, --long-option  this is option a [deprecated - has been deprecated and is scheduled to be removed in Gradle 5.0. don\'t use this]',
            '-b                 [deprecated - has been deprecated and is scheduled to be removed in Gradle 5.0. will be removed]',
